...
## SHORTHAND FOR _grid-row/column-start/end_ is _grid-row/column_
...
`_span grid items across multiple grid cells in order to occupy entire areas._`
...
##### Method 1: _LINE NUMBERS_

##### Method 2: _LINE NAMES_
